...
- Fixed a bug in `admin.py` and `backup.py` where update checks, upgrades, and backup exports were checking and installing the obsolete package name `mirrordash-core` (version 0.0.1) instead of the active PyPI package name `mirrordash` (version 0.2.3).
